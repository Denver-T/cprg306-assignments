...
export default function NewItem({ onAddItem }) {
  ...
  //return values
  return (
    <div className="m-4 w-110 flex-col items-start rounded-lg border-2 border-rose-300 bg-linear-to-r from-rose-900 to-rose-950 p-4">
      <form onSubmit={handleSubmit}>
        ...
        <p className="text-xs">(Available from 1 - 20)</p>
